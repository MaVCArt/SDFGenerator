...
sdf_id = SDFGenerator.calculate_sdf_color_id(img_id, coord_map, output) / 255.0
SDFGenerator.utils.np_arr_to_img(sdf_id).resize(resize_output).save('example_assets/output_id.png')
